...
class SearchController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        {
            $products = Product::where('category_id', $inputCategory)->paginate(18);
        }
        ...
        elseif (isset($inputKeyword) && $inputSubCategory == 'all')
        {
            ...
            $products = Product::whereIn('id', $product_ids)->paginate(18);
        ...
        {
            $products = Product::where('identifier', $inputSubCategory)->paginate(18);
        }
