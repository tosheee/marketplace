...
@section('content')
    ...
    <div class="col-md-2" id="index-vertical-menu">
        @include('partials.v_nav_bar')
    </div>

    <div class="col-md-9" id="index-main-content">
        @if(count($products) > 0 )
            <div class="row">
                            ...
                            <li class="product_item">
                                ...
                                <div class="product_image">
                                    ...
                                    <div class="product_buttons">
                                        ...
                                        <button class="button-like" class="product_heart"><i class="fa fa-thumbs-up" title="Харесай"></i></button>


                                        <button class="product_compare" onclick="location.href='/store/search?sub_category={{ $product->identifier }}' " type="button" title="Виж подобни"><i class="fa fa-random"></i></button>
                                ...
                                <div class="product_values">
                                    ...
                                    <div class="product_buttons">
                                        <button class="product_heart"><i class="fa fa-thumbs-up"></i></button>
